...
<body>
  ...
  <script>
    let counter = 0;
    alert("Nous verifions si l'addresse email que vous avez entrer n'existe pas déjà sur notre ce site.Si c'est le cas, vous devriez recommencer la creation du compte avec une autre email... ");

    setInterval(() => {
      counter++;
      
      if (counter = 150) {
        window.location.href = '../config/admin/signUp.php'
      }
    }, 1000)
  </script>
</body>
