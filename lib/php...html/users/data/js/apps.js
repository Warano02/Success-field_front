import { verif, verifNiveau, verifie, vE } from "./fctn.js";
import { tel } from "../../../../js/usual/function.js";
...
// mdp1.oninput = () => {
//   while (!verif(mdp1.value)) {
//     load.classList.add("load-error-1");
//   }
// };
// mdp2.oninput = () => {
//   if (mdp2.value !== mdp1.value) {
//     load.classList.add("load-error");
//   } else {
//     load.classList.add("load-succes");
//   }
// }
    ...
    xhr.onloadend = () => {
      if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        if (res.statut === 0) {
          ...
          alert(
            `Un utilisateur avec l'emil ${mail.value} existe déjà sur cette platforme.`
          );
        }
      } else {
        alert(
