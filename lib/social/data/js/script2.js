...
document.querySelector(".fa-facebook-messenger").addEventListener("click", () => window.location.href = "./Messages.php")
...
OK.onloadend = () => {
  ...
  if (!query(href)) {
    ...
    xhr.onloadend = () => {
       ...
       */
      document.getElementById("np").textContent = pub.length + "+"
      ...
      `
          ...
          publish_comment.setRequestHeader("X-API_KEY", "Warano0101101225@carineteoi@gmzil58ldl.hdk+")
